...
public class SpineAnimationManager : AnimationManager
{
    new protected  string movement = null;
    new  string Movement
    {
        get { return movement; }
        set
    ...
    new protected  string command = null;
    new  string Command
    {
        get { return command; }
        set 
    ...
    new protected  string handicap = null;
    new  string Handicap
    {
        get { return handicap; }
        set
